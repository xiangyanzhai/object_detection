...
def resnet50(config, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(config,Bottleneck, [3, 4, 6, 3], **kwargs)
...
if __name__ == "__main__":
    ...
    model_file = '../train_one_GPU/models/Faster_50_90000_1.pth'
    test(model, config, model_file)


# [0.76946987 0.77629407 0.7619221  0.65809572 0.60119144 0.86763914
#  0.80106185 0.87564514 0.56657916 0.83396843 0.68328569 0.85744865
#  0.84706547 0.75069867 0.78708695 0.47186125 0.75084142 0.72421691
#  0.82794906 0.74733409]
# 0.7479827539005699