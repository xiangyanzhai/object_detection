...
for i in Label:
    ...
    c += 1
print(Label_dict)
train_dir = r'D:/dataset/voc/VOCdevkit/VOC2012/JPEGImages/'
names = os.listdir(train_dir)
names = [name.split('.')[0] for name in names]
names = sorted(names)
ann_path = 'D:/dataset/voc/VOCdevkit/VOC2012/Annotations/'
c = 0
img_paths = []
Bboxes = []
# np.random.seed(50)
...
joblib.dump(img_paths, 'img_paths_12.pkl')
joblib.dump(Bboxes, 'Bboxes_12.pkl')
